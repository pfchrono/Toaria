namespace Terraria
{
    ...
    public class messageBuffer
    {
        ...
        public void GetData(int start, int length)
        {
            ...
            int idx = 0;
            idx = start + 1;
            msgid = this.readBuffer[start];
            if (!NetHooks.OnGetData(ref msgid, this, ref idx, ref length))
            {
                ...
                if (((Main.netMode == 2) && (msgid != 0x26)) && (Netplay.serverSock[this.whoAmI].state == -1))
                {
                    NetMessage.SendData(2, this.whoAmI, -1, "Incorrect password.", 0, 0f, 0f, 0f, 0);
                    return;
                }
                if ((((Main.netMode == 2) && (Netplay.serverSock[this.whoAmI].state < 10)) && ((msgid > 12) && (msgid != 0x10))) && (((msgid != 0x2a) && (msgid != 50)) && (msgid != 0x26)))
                {
                    NetMessage.BootPlayer(this.whoAmI, "Invalid operation at this state.");
                }
                if ((msgid == 1) && (Main.netMode == 2))
                {
                ...
                switch (msgid)
                {
                    ...
                    case 7:
                        if (Main.netMode == 1)
                        {
                            Main.time = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.dayTime = false;
                            if (this.readBuffer[idx] == 1)
                            {
                                Main.dayTime = true;
                            }
                            idx++;
                            Main.moonPhase = this.readBuffer[idx];
                            idx++;
                            int num15 = this.readBuffer[idx];
                            idx++;
                            if (num15 == 1)
                            {
                                Main.bloodMoon = true;
                            ...
                            Main.maxTilesX = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.maxTilesY = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.spawnTileX = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.spawnTileY = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.worldSurface = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.rockLayer = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            Main.worldID = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            byte num16 = this.readBuffer[idx];
                            if ((num16 & 1) == 1)
                            {
                            ...
                            idx++;
                            Main.worldName = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                    ...
                    case 4:
                    {
                        ...
                        if (num7 != Main.myPlayer)
                        {
                            ...
                            Main.player[num7].hairColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].hairColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].hairColor.B = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].skinColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].skinColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].skinColor.B = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].eyeColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].eyeColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].eyeColor.B = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].shirtColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].shirtColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].shirtColor.B = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].underShirtColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].underShirtColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].underShirtColor.B = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].pantsColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].pantsColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].pantsColor.B = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].shoeColor.R = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].shoeColor.G = this.readBuffer[idx];
                            idx++;
                            Main.player[num7].shoeColor.B = this.readBuffer[idx];
                            idx++;
                            byte num10 = this.readBuffer[idx];
                            Main.player[num7].difficulty = num10;
                            idx++;
                            string text = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start).Trim();
                    ...
                    case 8:
                        if (Main.netMode == 2)
                        {
                            int num17 = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            int num18 = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            bool flag3 = true;
                            if ((num17 == -1) || (num18 == -1))
                            {
                            ...
                            else if ((num17 < 10) || (num17 > (Main.maxTilesX - 10)))
                            {
                                flag3 = false;
                            }
                            else if ((num18 < 10) || (num18 > (Main.maxTilesY - 10)))
                            {
                                flag3 = false;
                            }
                            int num19 = 0x546;
                            ...
                            if (flag3)
                            {
                                num17 = Netplay.GetSectionX(num17);
                                num18 = Netplay.GetSectionY(num18);
                                for (int num24 = num17 - 2; num24 < (num17 + 3); num24++)
                                {
                                    for (int num25 = num18 - 1; num25 < (num18 + 2); num25++)
                                    {
                                        NetMessage.SendSection(this.whoAmI, num24, num25);
                                    }
                                }
                                NetMessage.SendData(11, this.whoAmI, -1, "", num17 - 2, (float) (num18 - 1), (float) (num17 + 2), (float) (num18 + 1), 0);
                            }
                ...
                if ((msgid == 10) && (Main.netMode == 1))
                {
                    ...
                    for (int num33 = num30; num33 < (num30 + num29); num33++)
                    {
                        ...
                        byte num32 = this.readBuffer[idx];
                        idx++;
                        ...
                        {
                            int num34 = Main.tile[num33, num31].type;
                            Main.tile[num33, num31].type = this.readBuffer[idx];
                            idx++;
                            if (Main.tileFrameImportant[Main.tile[num33, num31].type])
                            {
                                Main.tile[num33, num31].frameX = BitConverter.ToInt16(this.readBuffer, idx);
                                idx += 2;
                                Main.tile[num33, num31].frameY = BitConverter.ToInt16(this.readBuffer, idx);
                                idx += 2;
                            }
                            else if (!active || (Main.tile[num33, num31].type != num34))
                            {
                        ...
                        {
                            Main.tile[num33, num31].wall = this.readBuffer[idx];
                            idx++;
                        }
                        if (Main.tile[num33, num31].liquid > 0)
                        {
                            Main.tile[num33, num31].liquid = this.readBuffer[idx];
                            idx++;
                            byte num35 = this.readBuffer[idx];
                            idx++;
                            if (num35 == 1)
                            {
                    ...
                    if (Main.netMode == 2)
                    {
                        NetMessage.SendData(msgid, -1, this.whoAmI, "", num29, (float) num30, (float) num31, 0f, 0);
                        return;
                    }
                    return;
                }
                if (msgid == 11)
                {
                    if (Main.netMode == 1)
                    {
                        int startX = BitConverter.ToInt16(this.readBuffer, idx);
                        idx += 4;
                        int startY = BitConverter.ToInt16(this.readBuffer, idx);
                        idx += 4;
                        int endX = BitConverter.ToInt16(this.readBuffer, idx);
                        idx += 4;
                        int endY = BitConverter.ToInt16(this.readBuffer, idx);
                        idx += 4;
                ...
                if (msgid == 12)
                {
                    int num40 = this.readBuffer[idx];
                    if (Main.netMode == 2)
                    {
                        num40 = this.whoAmI;
                    }
                    idx++;
                    Main.player[num40].SpawnX = BitConverter.ToInt32(this.readBuffer, idx);
                    idx += 4;
                    Main.player[num40].SpawnY = BitConverter.ToInt32(this.readBuffer, idx);
                    idx += 4;
                ...
                if (msgid == 13)
                {
                    ...
                    if (num41 != Main.myPlayer)
                    {
                        ...
                        idx++;
                        int num42 = this.readBuffer[idx];
                        idx++;
                        int num43 = this.readBuffer[idx];
                        idx++;
                        float num44 = BitConverter.ToSingle(this.readBuffer, idx);
                        idx += 4;
                        float num45 = BitConverter.ToSingle(this.readBuffer, idx);
                        idx += 4;
                        float num46 = BitConverter.ToSingle(this.readBuffer, idx);
                        idx += 4;
                        float num47 = BitConverter.ToSingle(this.readBuffer, idx);
                        idx += 4;
                ...
                if (msgid == 14)
                {
                    if (Main.netMode == 1)
                    {
                        int num48 = this.readBuffer[idx];
                        idx++;
                        int num49 = this.readBuffer[idx];
                        if (num49 == 1)
                        {
                ...
                if (msgid == 0x10)
                {
                    int num50 = this.readBuffer[idx];
                    idx++;
                    if (num50 != Main.myPlayer)
                    {
                        int num51 = BitConverter.ToInt16(this.readBuffer, idx);
                        idx += 2;
                        int num52 = BitConverter.ToInt16(this.readBuffer, idx);
                        if (Main.netMode == 2)
                        {
                            num50 = this.whoAmI;
                        }
                ...
                if (msgid != 0x11)
                {
                    if (msgid == 0x12)
                    {
                        if (Main.netMode == 1)
                        {
                            byte num58 = this.readBuffer[idx];
                            idx++;
                            int num59 = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            short num60 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            short num61 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            if (num58 == 1)
                            {
                                Main.dayTime = true;
                    ...
                    if (msgid != 0x13)
                    {
                        if (msgid == 20)
                        {
                            ...
                            for (int num71 = num68; num71 < (num68 + num67); num71++)
                            {
                                for (int num72 = num69; num72 < (num69 + num67); num72++)
                                {
                                    ...
                                    byte num70 = this.readBuffer[idx];
                                    idx++;
                                    ...
                                    if (Main.tile[num71, num72].active)
                                    {
                                        ...
                                        Main.tile[num71, num72].type = this.readBuffer[idx];
                                        idx++;
                                        if (Main.tileFrameImportant[Main.tile[num71, num72].type])
                                        {
                                            Main.tile[num71, num72].frameX = BitConverter.ToInt16(this.readBuffer, idx);
                                            idx += 2;
                                            Main.tile[num71, num72].frameY = BitConverter.ToInt16(this.readBuffer, idx);
                                            idx += 2;
                                        }
                                    ...
                                    {
                                        Main.tile[num71, num72].wall = this.readBuffer[idx];
                                        idx++;
                                    }
                                    if (Main.tile[num71, num72].liquid > 0)
                                    {
                                        Main.tile[num71, num72].liquid = this.readBuffer[idx];
                                        idx++;
                                        byte num74 = this.readBuffer[idx];
                                        idx++;
                                        if (num74 == 1)
                                        {
                            ...
                            if (Main.netMode == 2)
                            {
                                NetMessage.SendData(msgid, -1, this.whoAmI, "", num67, (float) num68, (float) num69, 0f, 0);
                                return;
                            }
                            return;
                        }
                        if (msgid == 0x15)
                        {
                            short num75 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            float num76 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num77 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num78 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num79 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            byte stack = this.readBuffer[idx];
                            idx++;
                            string str5 = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                            if (Main.netMode == 1)
                            {
                                if (str5 == "0")
                                {
                        ...
                        if (msgid == 0x16)
                        {
                            short num81 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            byte num82 = this.readBuffer[idx];
                        ...
                        if ((msgid == 0x17) && (Main.netMode == 1))
                        {
                            short num83 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            float num84 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num85 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num86 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num87 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            int num88 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            int num89 = this.readBuffer[idx] - 1;
                            idx++;
                            int num90 = this.readBuffer[idx] - 1;
                            idx++;
                            int num91 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            float[] numArray = new float[NPC.maxAI];
                            for (int num92 = 0; num92 < NPC.maxAI; num92++)
                            {
                                numArray[num92] = BitConverter.ToSingle(this.readBuffer, idx);
                                idx += 4;
                            }
                            string name = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                        ...
                        if (msgid == 0x18)
                        {
                            short num94 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            byte num95 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                        ...
                        if (msgid == 0x1a)
                        {
                            byte num102 = this.readBuffer[idx];
                            if (((Main.netMode != 2) || (this.whoAmI == num102)) || (Main.player[num102].hostile && Main.player[this.whoAmI].hostile))
                            {
                                idx++;
                                int hitDirection = this.readBuffer[idx] - 1;
                                idx++;
                                short damage = BitConverter.ToInt16(this.readBuffer, idx);
                                idx += 2;
                                byte num105 = this.readBuffer[idx];
                                idx++;
                                bool pvp = false;
                                byte num106 = this.readBuffer[idx];
                                idx++;
                                bool crit = false;
                                string deathText = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                                if (num105 != 0)
                                {
                                    pvp = true;
                                }
                        ...
                        if (msgid == 0x1b)
                        {
                            short num107 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            float num108 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num109 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num110 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num111 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            float num112 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            short num113 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            byte num114 = this.readBuffer[idx];
                            idx++;
                            byte num115 = this.readBuffer[idx];
                            idx++;
                            float[] numArray2 = new float[Projectile.maxAI];
                            for (int num116 = 0; num116 < Projectile.maxAI; num116++)
                            {
                                numArray2[num116] = BitConverter.ToSingle(this.readBuffer, idx);
                                idx += 4;
                            }
                            int num117 = 0x3e8;
                        ...
                        if (msgid == 0x1c)
                        {
                            short num121 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            short num122 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            float knockBack = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            int num124 = this.readBuffer[idx] - 1;
                            idx++;
                            int num125 = this.readBuffer[idx];
                            if (num122 >= 0)
                            {
                                if (num125 == 1)
                                {
                        ...
                        if (msgid == 0x1d)
                        {
                            short num126 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            byte num127 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                        ...
                        if (msgid == 30)
                        {
                            byte num129 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num129 = (byte) this.whoAmI;
                            }
                            idx++;
                            byte num130 = this.readBuffer[idx];
                            if (num130 == 1)
                            {
                        ...
                        if (msgid == 0x1f)
                        {
                            if (Main.netMode == 2)
                            {
                                int num131 = BitConverter.ToInt32(this.readBuffer, idx);
                                idx += 4;
                                int num132 = BitConverter.ToInt32(this.readBuffer, idx);
                                idx += 4;
                        ...
                        if (msgid == 0x20)
                        {
                            int num135 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            int num136 = this.readBuffer[idx];
                            idx++;
                            int num137 = this.readBuffer[idx];
                            idx++;
                            string str13 = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                        ...
                        if (msgid == 0x21)
                        {
                            int num138 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            int num139 = BitConverter.ToInt32(this.readBuffer, idx);
                            idx += 4;
                            int num140 = BitConverter.ToInt32(this.readBuffer, idx);
                            if (Main.netMode == 1)
                            {
                        ...
                        if (msgid == 0x22)
                        {
                            if (Main.netMode == 2)
                            {
                                int num141 = BitConverter.ToInt32(this.readBuffer, idx);
                                idx += 4;
                                int num142 = BitConverter.ToInt32(this.readBuffer, idx);
                        ...
                        if (msgid == 0x23)
                        {
                            int num143 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num143 = this.whoAmI;
                            }
                            idx++;
                            int healAmount = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                        ...
                        if (msgid == 0x24)
                        {
                            int num145 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num145 = this.whoAmI;
                            }
                            idx++;
                            int num146 = this.readBuffer[idx];
                            idx++;
                            int num147 = this.readBuffer[idx];
                            idx++;
                            int num148 = this.readBuffer[idx];
                            idx++;
                            int num149 = this.readBuffer[idx];
                            idx++;
                            if (num146 == 0)
                            {
                        ...
                        if (msgid == 0x26)
                        {
                            if (Main.netMode == 2)
                            {
                                if (Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start) == Netplay.password)
                                {
                                    Netplay.serverSock[this.whoAmI].state = 1;
                                    NetMessage.SendData(3, this.whoAmI, -1, "", 0, 0f, 0f, 0f, 0);
                                    return;
                        ...
                        if ((msgid == 0x27) && (Main.netMode == 1))
                        {
                            short num150 = BitConverter.ToInt16(this.readBuffer, idx);
                        ...
                        if (msgid == 40)
                        {
                            byte num151 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num151 = (byte) this.whoAmI;
                            }
                            idx++;
                            int num152 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                        ...
                        if (msgid == 0x29)
                        {
                            byte num153 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num153 = (byte) this.whoAmI;
                            }
                            idx++;
                            float num154 = BitConverter.ToSingle(this.readBuffer, idx);
                            idx += 4;
                            int num155 = BitConverter.ToInt16(this.readBuffer, idx);
                        ...
                        if (msgid == 0x2a)
                        {
                            int num156 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num156 = this.whoAmI;
                            }
                            idx++;
                            int num157 = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                            int num158 = BitConverter.ToInt16(this.readBuffer, idx);
                            if (Main.netMode == 2)
                            {
                                num156 = this.whoAmI;
                            }
                        ...
                        if (msgid == 0x2b)
                        {
                            int num159 = this.readBuffer[idx];
                            if (Main.netMode == 2)
                            {
                                num159 = this.whoAmI;
                            }
                            idx++;
                            int manaAmount = BitConverter.ToInt16(this.readBuffer, idx);
                            idx += 2;
                        ...
                        if (msgid == 0x2c)
                        {
                            byte num161 = this.readBuffer[idx];
                            if (num161 != Main.myPlayer)
                            {
                                ...
                                idx++;
                                int num162 = this.readBuffer[idx] - 1;
                                idx++;
                                short num163 = BitConverter.ToInt16(this.readBuffer, idx);
                                idx += 2;
                                byte num164 = this.readBuffer[idx];
                                idx++;
                                string str15 = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                                bool flag10 = false;
                                if (num164 != 0)
                                {
                                    flag10 = true;
                        ...
                        if (msgid != 0x2d)
                        {
                            switch (msgid)
                            {
                                case 0x2e:
                                    if (Main.netMode == 2)
                                    {
                                        int num169 = BitConverter.ToInt32(this.readBuffer, idx);
                                        idx += 4;
                                        int num170 = BitConverter.ToInt32(this.readBuffer, idx);
                                        idx += 4;
                                ...
                                case 0x2f:
                                {
                                    int num172 = BitConverter.ToInt16(this.readBuffer, idx);
                                    idx += 2;
                                    int num173 = BitConverter.ToInt32(this.readBuffer, idx);
                                    idx += 4;
                                    int num174 = BitConverter.ToInt32(this.readBuffer, idx);
                                    idx += 4;
                                    string str17 = Encoding.ASCII.GetString(this.readBuffer, idx, (length - idx) + start);
                            ...
                            if (msgid == 0x30)
                            {
                                int num175 = BitConverter.ToInt32(this.readBuffer, idx);
                                idx += 4;
                                int num176 = BitConverter.ToInt32(this.readBuffer, idx);
                                idx += 4;
                                byte num177 = this.readBuffer[idx];
                                idx++;
                                byte num178 = this.readBuffer[idx];
                                idx++;
                            ...
                            else
                            {
                                switch (msgid)
                                {
                                    case 0x34:
                                    {
                                        byte num191 = this.readBuffer[idx];
                                        idx++;
                                        byte num192 = this.readBuffer[idx];
                                        idx++;
                                        int num193 = BitConverter.ToInt32(this.readBuffer, idx);
                                        idx += 4;
                                        int num194 = BitConverter.ToInt32(this.readBuffer, idx);
                                        idx += 4;
                                        if (num192 == 1)
                                        {
                                    ...
                                    case 0x35:
                                    {
                                        short num195 = BitConverter.ToInt16(this.readBuffer, idx);
                                        idx += 2;
                                        byte num196 = this.readBuffer[idx];
                                        idx++;
                                        short time = BitConverter.ToInt16(this.readBuffer, idx);
                                        idx += 2;
                                    ...
                                    case 0x36:
                                        if (Main.netMode == 1)
                                        {
                                            short num198 = BitConverter.ToInt16(this.readBuffer, idx);
                                            idx += 2;
                                            for (int num199 = 0; num199 < 5; num199++)
                                            {
                                                Main.npc[num198].buffType[num199] = this.readBuffer[idx];
                                                idx++;
                                                Main.npc[num198].buffTime[num199] = BitConverter.ToInt16(this.readBuffer, idx);
                                                idx += 2;
                                            }
                                            return;
                                        }
                                    ...
                                    case 0x33:
                                    {
                                        byte num189 = this.readBuffer[idx];
                                        idx++;
                                        byte num190 = this.readBuffer[idx];
                                        switch (num190)
                                        {
                                            case 1:
                                                NPC.SpawnSkeletron();
                                    ...
                                    case 50:
                                    {
                                        int num187 = this.readBuffer[idx];
                                        idx++;
                                        if (Main.netMode == 2)
                                        {
                                            num187 = this.whoAmI;
                                        ...
                                        {
                                            Main.player[num187].buffType[num188] = this.readBuffer[idx];
                                ...
                                if (msgid == 0x37)
                                {
                                    byte num200 = this.readBuffer[idx];
                                    idx++;
                                    byte num201 = this.readBuffer[idx];
                                    idx++;
                                    short num202 = BitConverter.ToInt16(this.readBuffer, idx);
                                    idx += 2;
                        ...
                        num165 = this.readBuffer[idx];
                        if (Main.netMode == 2)
                        {
                            num165 = this.whoAmI;
                        }
                        idx++;
                        num166 = this.readBuffer[idx];
                        idx++;
                    ...
                    num62 = this.readBuffer[idx];
                    idx++;
                    num63 = BitConverter.ToInt32(this.readBuffer, idx);
                    idx += 4;
                    num64 = BitConverter.ToInt32(this.readBuffer, idx);
                    idx += 4;
                    num65 = this.readBuffer[idx];
                    int direction = 0;
                    if (num65 == 0)
                    {
                        direction = -1;
                ...
                byte number = this.readBuffer[idx];
                idx++;
                int x = BitConverter.ToInt32(this.readBuffer, idx);
                idx += 4;
                int y = BitConverter.ToInt32(this.readBuffer, idx);
                idx += 4;
                byte type = this.readBuffer[idx];
                idx++;
                int style = this.readBuffer[idx];
                bool fail = false;
                if (type == 1)
                {
                    fail = true;
                ...
                if (Main.netMode == 2)
                {
                    ...
                    if (!Netplay.serverSock[this.whoAmI].tileSection[Netplay.GetSectionX(x), Netplay.GetSectionY(y)])
                    {
                        fail = true;
                    }
                }
                ...
                if (Main.netMode == 2)
                {
                    NetMessage.SendData(0x11, -1, this.whoAmI, "", number, (float) x, (float) y, (float) type, style);
                    if ((number != 1) || (type != 0x35))
                    {
                        return;
                    }
