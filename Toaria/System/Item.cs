        ...
        public void UpdateItem(int i)
        {
            if (this.active)
            {
                ...
                if (!this.beingGrabbed)
                {
                    ...
                    if ((((this.owner == Main.myPlayer) && this.lavaWet) && ((this.type != 0x138) && (this.type != 0x13e))) && (((this.type != 0xad) && (this.type != 0xae)) && ((this.type != 0xaf) && (this.rare == 0))))
                    {
                        if ((this.type == 0x10b) && (Main.netMode != 1))
                        {
                            for (int m = 0; m < 0x3e8; m++)
                            {
                                if (Main.npc[m].active && (Main.npc[m].type == 0x16))
                                {
                                    ...
                                    Main.npc[m].StrikeNPC(0x270f, 10f, -Main.npc[m].direction, false);
                                }
                            }
                        }
                        this.active = false;
                ...
                else if ((this.type == 0x11a) || (this.type == 0x11e))
                {
                    Lighting.addLight((int) ((this.position.X - 7f) / 16f), (int) ((this.position.Y - 7f) / 16f), 1f);
                }
                else if (this.type == 0x14b)
